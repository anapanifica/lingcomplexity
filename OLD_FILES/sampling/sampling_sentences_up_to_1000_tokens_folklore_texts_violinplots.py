...
##    plt.show()
    ...
    languages = ['agx-folk', 'ava-folk', 'kum-folk', 'rut-folk', 'dar-folk', 'tab-folk',
                 'lak-folk', 'lez-folk', 'nog-folk', 'tkr-folk', 'tat-folk',
                 #'rus-folk',
...
##        sns.distplot(values, hist = False, kde = True, kde_kws = {'shade': True, 'linewidth': 2}, label = language)
    ...
    path = '/Users/apanova/Library/CloudStorage/OneDrive-Личная/Documents/ConLab/LingComplexity/linguistic-complexity/statistics_ttr/TTR_100_datapoints_per_language_folk.txt'
